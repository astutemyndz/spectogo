<div id="main" class="content_section">
    ...
    <div class="tab-content px-0">
        ...
        <div class="tab-pane setup-content" id="prescription" role="tabpanel" aria-labelledby="nav-prescription-tab">
            ...
            <div class="container border-bottom pt-4 pb-4 addPresDiv">
                ...
                <form class="prescription_form" enctype="multiple/form-data">
                    <div class="row pt-5">
                    ...
                    <div class="form-row">
                                ...
                                <div class="form-group col-md-5 col-sm-5"><span class="font-weight-bold text-color-8">LE </span><span class="text-color-5">(Left Eye)</span></div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-5 col-sm-5">
                                            <select name="prescription[details][0][sphere]" class="form-control">
                                        ...
                                        <input type="hidden" name="prescription[details][0][eye]" value="right">
                                        <div class="form-group col-md-5 col-sm-5">
                                            <select name="prescription[details][1][sphere]" class="form-control">
                                                <option value="">NONE</option>
                                                <?php for($i = -20; $i<= 12 ; $i = $i+0.25 ){ ?>
                                                    <option value="<?=$i?>"><?=$i?></option>
                                                <?php } ?>
                                        ...
                                        <input type="hidden" name="prescription[details][1][eye]" value="left">
                                    </div>
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-5 col-sm-5">
                                            <select name="prescription[details][0][cylinder]" class="form-control">
                                                <option value="">NONE</option>
                                        ...
                                        <div class="form-group col-md-5 col-sm-5">
                                            <select name="prescription[details][1][cylinder]" class="form-control">
                                                <option value="">NONE</option>
                                                <?php for($i = -6; $i<= 6 ; $i = $i+0.25 ){ ?>
                                                    <option value="<?=$i?>"><?=$i?></option>
                                                <?php } ?>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-5 col-sm-5">
                                            <select name="prescription[details][0][axis]" class="form-control">
                                                <option value="">NONE</option>
                                                <?php for($i = 1; $i<= 180 ; $i++ ){ ?>
                                                    <option value="<?=$i?>"><?=$i?></option>
                                                <?php } ?>
                                        ...
                                        <div class="form-group col-md-5 col-sm-5">
                                            <select name="prescription[details][1][axis]" class="form-control">
                                                <option value="">NONE</option>
                                                <?php for($i = 1; $i<= 180 ; $i++ ){ ?>
                                                    <option value="<?=$i?>"><?=$i?></option>
                                                <?php } ?>
                        ...
                        <div class="copy-prescription-form copyPrescriptionForm d-none" id="copyPrescriptionForm">
                            ...
                            <div class="form-row">
                                        ...
                                        <input type="hidden" name="prescription[prism][0][horizontal_prism]" value="right">
                                        <div class="form-group col-md-5 col-sm-5">
                                            <select name="prescription[prism][0][horizontal_prism]" class="form-control">
                                                <option value="">NONE</option>
                                                <?php for($i = 0.25; $i<= 3 ; $i = $i+0.25 ){ ?>
                                                    <option value="<?=$i?>"><?=$i?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <input type="hidden" name="prescription[prism][1][horizontal_prism]" value="left">
                                        <div class="form-group col-md-5 col-sm-5">
                                            <select name="prescription[prism][1][horizontal_prism]" class="form-control">
                                                <option value="">NONE</option>
                                                <?php for($i = 0.25; $i<= 3 ; $i = $i+0.25 ){ ?>
                                                    <option value="<?=$i?>"><?=$i?></option>
                                                <?php } ?>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-5 col-sm-5">
                                            <select name="prescription[prism][0][horizontal_prism][base_direction]" class="form-control">
                                                    <option value="">NONE</option>
                                        ...
                                        <div class="form-group col-md-5 col-sm-5">
                                            <select name="prescription[prism][1][horizontal_prism][base_direction]" class="form-control">
                                                    <option value="">NONE</option>
                                                    <option value="In">In</option>
                                                    <option value="Out">Out</option>
                                            </select>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-5 col-sm-5">
                                            <select name="prescription[prism][0][vertical_prism]" class="form-control">
                                                <option value="">NONE</option>
                                                <?php for($i = 0.25; $i<= 3 ; $i = $i+0.25 ){ ?>
                                                    <option value="<?=$i?>"><?=$i?></option>
                                                <?php } ?>
                                        ...
                                        <div class="form-group col-md-5 col-sm-5">
                                            <select class="form-control">
                                                <option name="prescription[prism][1][vertical_prism]" value="">NONE</option>
                                                <?php for($i = 0.25; $i<= 3 ; $i = $i+0.25 ){ ?>
                                                    <option value="<?=$i?>"><?=$i?></option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-5 col-sm-5">
                                            <select name="prescription[prism][0][vertical_prism][base_direction]" class="form-control">
                                                    <option value="">NONE</option>
                                                    <option value="In">In</option>
                                                    <option value="Out">Out</option>
                                            </select>
                                        ...
                                        <div class="form-group col-md-5 col-sm-5">
                                            <select name="prescription[prism][1][vertical_prism][base_direction]" class="form-control">
                                            <option value="">NONE</option>
                                                    <option value="In">In</option>
                                                    <option value="Out">Out</option>
                                            </select>
                        ...
                        <div class="upload-btn-wrapper">
                            ...
                            <input id="attachment" type="file" name="files" data-url="<?php echo base_url();?>attachmentUploadHandler">
                            <input type="hidden" value="" id="attachmentPrescription" name="prescription[attachment]">
                            </div>
                            <p class="loader"></p>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-4 border-left">
                        ...
                        <div class="form-group col-md-12 text-left">
                            <select name="prescription[id_pupillary_distance]" id="pupillaryDistance" class="form-control mb-2">
                        ...
                        <div class="form-row addAdditionalInfoTextArea d-none" id="addAdditionalInfoTextArea">
                            <div class="form-group col-md-12 text-left"> 
                            <input name="prescription[additional_information]" type="text" class="form-control mt-3 mb-2">
                            </div>
                        </div>
                    ...
                    <div class="row mt-5">
                    <div class="col-12">
                        <button  type="button" class="PrescriptionButton text-white btn btn-primary text-uppercase pt-2 pb-2 pl-4 pr-4">Next step - Choose lenses <i class="fa fa-angle-double-right" aria-hidden="true"></i></button>
                    </div>
                    </div>
                </form>
                </div>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-md-3 col-sm-3 col-12 text-md-left text-center mb-sm-0 mb-4">
                                            <ul class="nav nav-tabs d-block" id="tintsTab" role="tablist"></ul>
                                        </div>
                                        <div class="col-md-9 col-sm-9 col-12">
                                            <div class="tab-content choose-your-lens">
                                                <div class="tab-pane" role="tabpanel">
                                                    <div class="row" id="tintsVision"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
