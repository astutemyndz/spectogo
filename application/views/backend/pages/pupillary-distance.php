    ...
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-content">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="section-subtitle"><b>PUPILLARY DISTANCE</b></h4>
                                ...
                                <table id="responsive-table" class="table data-table table-striped table-hover responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="height: 60px;">
                                            ...
                                            <td>
                                                <a href="javascript:void(0)" id="<?=$pd->id?>" class="change-status" data-table="pupillary_distance" data-url="admin/change-status" title="Status | Green:Active, Red:InActive">
                                                    <?php if($pd->status == 1){ ?>
                                            ...
                                            <td>
                                                <a href="<?=base_url('admin/edit-pupillary-distance/'.$pd->id)?>">
                                        ...
                                        <tr style="height:50px; text-align: center; font-weight: bolder;">
                                            <td colspan="3">No Pupillary Distance Found !!!</td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
