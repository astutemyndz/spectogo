    ...
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-content">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="section-subtitle"><b>LENS SUB CATEGORY</b></h4>
                        ...
                        <div class="panel">
                            <div class="panel-content">
                                <table id="responsive-table" class="table table-striped table-hover responsive nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>Lens Sub Category Name</th>
                                            <th>Image</th>
                                            <th>Lens Category Name</th>
                                            <th>Status</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr style="height: 60px;">
                                            <td>
                                                <?=$lenss['lens_sub_cat_name']?>
                                            </td>
                                            <td>
                                                <img src="<?=base_url('assets/images/lensSubCatImage/'.$lenss['image'])?>">
                                            </td>
                                            <td>
                                                <?=$lenss['lens_cat_name']?>
                                            </td>
                                            <td>
                                                <a href="javascript:void(0)" id="<?=$lenss['id']?>" class="change-status" data-table="lens_sub_category" data-url="admin/change-status" title="Status | Green:Active, Red:InActive">
                                            ...
                                            <td>
                                                <a href="<?=base_url('admin/edit-lens-sub-category/'.$lenss['id'])?>">
                                        ...
                                        <tr style="height:50px; text-align: center; font-weight: bolder;">
                                            <td colspan="5">No Lens Sub Category Found !!!</td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
