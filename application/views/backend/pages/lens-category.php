    ...
    <div class="col-sm-12">
        <div class="panel">
            <div class="panel-content">
                <div class="row">
                    <div class="col-sm-12">
                        <h4 class="section-subtitle"><b>LENS CATEGORY</b></h4>
                                ...
                                <table id="responsive-table" class="table table-striped table-hover responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="height: 60px;">
                                            ...
                                            <td>
                                                <a href="javascript:void(0)" id="<?=$lenss->id?>" class="change-status" data-table="lens_category" data-url="admin/change-status" title="Status | Green:Active, Red:InActive">
                                            ...
                                            <td>
                                                <a href="<?=base_url('admin/edit-lens/'.$lenss->id)?>">
                                        ...
                                        <tr style="height:50px; text-align: center; font-weight: bolder;">
                                            <td colspan="3">No Lens Category Found !!!</td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
